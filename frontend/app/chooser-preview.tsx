...
// Route temporanea SOLO per anteprima del nuovo HomeChooser tier-aware.
// Verrà rimossa dopo l'approvazione utente.
...
export default function ChooserPreview() {
  ...
  const initVariant = ((params.variant as any) || "free_full") as "premium" | "free_full" | "free_partial" | "free_exhausted";
  const [variant, setVariant] = React.useState<"premium" | "free_full" | "free_partial" | "free_exhausted">(initVariant);
