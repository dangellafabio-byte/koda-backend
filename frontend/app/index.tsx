...
export default function Taccuino() {
  ...
  const KODA_BUILD_SHORT_TAG = "build-v64.9-neonborder-off-android-diag";
...
{showSettings && (<>
  ...
  const neonThickness =
    ...
    3;
  const neonBorderEl = (
    // === TEST DIAGNOSTICO 2026-07-30 v64.9 =====================================
    // NeonBorder DISATTIVATO COMPLETAMENTE su Android per verificare se è la
    // causa del flash schermo. Test binario: se il flash sparisce → causa
    // confermata (anche se il meccanismo esatto era poco chiaro). Se resta →
    // NeonBorder escluso definitivamente, passiamo al prossimo sospetto.
    // Reversibile in 5 secondi. Su iOS il rendering resta identico.
    // ========================================================================
