...
export default function Taccuino() {
  ...
  const KODA_BUILD_SHORT_TAG = "build-v64.16-radialglow-off-android";
...
{showSettings && (<>
      ...
      {/* RadialGlow — alone radiale che parte dal blob (centro schermo)
          ...
          ==================================================================== */}
      {/* v64.16 (2026-08-01) — A/B test performance: RadialGlow disabilitato
          su Android. Ha 4 Animated.loop con useNativeDriver:false che pulsano
          un gradient SVG full-screen. Su Xiaomi tablet FPS resta a 13-14
          anche in idle (misurato v64.15, sotto: 0.0 root render/s, 0.8 bubble
          render/s, FPS 13 costante). Se v64.16 riporta FPS >60 → RadialGlow
          confermato come causa e faremo un fix definitivo. Su iOS resta
          attivo (nessun problema rilevato). */}
      {Platform.OS === "ios" && <RadialGlow status={status as any} />}
