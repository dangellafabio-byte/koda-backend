...
export default function Taccuino() {
  ...
  useEffect(() => {
    console.log(
      `[KODA_BUILDTAG] build-v64.3-voice-change-diag v64.2-orb-sfogo-and-voice-sync+railway-hardcoded+diag-card+ws-piggyback build=2026-07-26 ` +
