...
export default function Taccuino() {
  ...
  useEffect(() => {
    console.log(
      `[KODA_BUILDTAG] v60.1-rollback-nova2+pcm-stats+quick-quality-4s+didnt-hear-canned+lascia-andare-vad-pulse+datetime-coercion+synthetic-done+preview-url build=2026-07-18 ` +
