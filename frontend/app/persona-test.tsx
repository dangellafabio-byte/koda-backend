...
const ROWS: TestRow[] = [
  ...
  },
  {
    ...
    response: "Accidenti, sì? Che è successo? Raccontami.",
    tone: "energetic",
    chars: 42,
  ...
  },
  {
    ...
    response: "Aspetta, ma poco fa mi dicevi che eri felicissimo. Che è successo tra te e tua madre?",
    tone: "concerned",
    chars: 85,
  ...
  },
  {
    ...
    prompt: "Boh.",
    response:
      "Ehi, aspetta. Non è un boh quello che sentiamo. C'è qualcosa sotto — magari rabbia, magari confusione. Prendi il tempo che serve e prova a dirmi: cosa è successo esattamente con tua madre?",
    tone: "calm",
    chars: 188,
  ...
  },
  {
    ...
    response: "Va bene. Sono qui quando sei pronto.",
    tone: "calm",
    chars: 36,
  ...
  },
  {
    ...
    response:
      "Non lo so ancora. Dimmela, la cazzata — così almeno sappiamo di cosa stiamo parlando.",
    tone: "calm",
    chars: 85,
  ...
  },
  {
    ...
    response: "Eh, immagino. Vuoi dirmi cos'è successo?",
    tone: "concerned",
    chars: 40,
  ...
  },
  {
    ...
    response: "Eh, allora dimmela — com'è andata? Dove vi siete conosciuti?",
    tone: "warm",
    chars: 60,
  ...
  },
  {
    ...
    response: "Ok, va bene. Sono qui se cambi idea, quando vuoi.",
    tone: "warm",
    chars: 49,
