...
const GIORNO: Palette = {
  ...
  label: "Giorno",
  emoji: "☀️",
  // === FIX 2026-06 (richiesta utente: "tema giorno deve essere bianco") ===
  // Tema diurno BIANCO puro. Testo nero/grigio scuro per leggibilità totale.
  isDark: false,
  bg: "#FFFFFF",
  surface: "#F5F5F5",
  ...
  primary: "#0E7C7B",
  primaryText: "#FFFFFF",
  primarySoftBg: "rgba(14,124,123,0.08)",
